...
public class MainActivity extends AppCompatActivity{
    ...
    public void fab_bottom(View view) {
        ...
        if (test_model.equals("test")){
            ...
            txData[5] = (byte) Integer.parseInt(test_f1);
            txData[6] = (byte) Integer.parseInt(test_f2);
            txData[7] = (byte) Integer.parseInt(test_f3);
            txData[8] = (byte) Integer.parseInt(test_f4);
            ...
            if (model.equals("fmajor")){
                ...
                txData[5] = (byte) Integer.parseInt(fmajor_cw_gd_f);
                txData[6] = (byte) Integer.parseInt(fmajor_cw_gd_h);
                txData[7] = (byte) Integer.parseInt(fmajor_cw_gd_m);
                ...
                txData[8] = (byte) Integer.parseInt(fmajor_cw_g_f);
                txData[9] = (byte) Integer.parseInt(fmajor_cw_g_h);
                txData[10] = (byte) Integer.parseInt(fmajor_cw_g_m);
                ...
                txData[11] = (byte) Integer.parseInt(fmajor_cw_gb_f);
                txData[12] = (byte) Integer.parseInt(fmajor_cw_gb_h);
                txData[13] = (byte) Integer.parseInt(fmajor_cw_gb_m);
                ...
                txData[14] = (byte) Integer.parseInt(fmajor_cw_a_f);
                txData[15] = (byte) Integer.parseInt(fmajor_cw_a_h);
                txData[16] = (byte) Integer.parseInt(fmajor_cw_a_m);
                ...
                txData[18] = (byte) Integer.parseInt(fmajor_ws_gd_f);
                txData[19] = (byte) Integer.parseInt(fmajor_ws_gd_h);
                txData[20] = (byte) Integer.parseInt(fmajor_ws_gd_m);
                ...
                txData[21] = (byte) Integer.parseInt(fmajor_ws_g_f);
                txData[22] = (byte) Integer.parseInt(fmajor_ws_g_h);
                txData[23] = (byte) Integer.parseInt(fmajor_ws_g_m);
                ...
                txData[24] = (byte) Integer.parseInt(fmajor_ws_gb_f);
                txData[25] = (byte) Integer.parseInt(fmajor_ws_gb_h);
                txData[26] = (byte) Integer.parseInt(fmajor_ws_gb_m);
                ...
                txData[27] = (byte) Integer.parseInt(fmajor_ws_a_f);
                txData[28] = (byte) Integer.parseInt(fmajor_ws_a_h);
                txData[29] = (byte) Integer.parseInt(fmajor_ws_a_m);
                ...
                txData[5] = (byte) Integer.parseInt(smajor_db_gd_f);
                txData[6] = (byte) Integer.parseInt(smajor_db_gd_h);
                txData[7] = (byte) Integer.parseInt(smajor_db_gd_m);
                ...
                txData[8] = (byte) Integer.parseInt(smajor_db_g_f);
                txData[9] = (byte) Integer.parseInt(smajor_db_g_h);
                txData[10] = (byte) Integer.parseInt(smajor_db_g_m);
                ...
                txData[11] = (byte) Integer.parseInt(smajor_db_gb_f);
                txData[12] = (byte) Integer.parseInt(smajor_db_gb_h);
                txData[13] = (byte) Integer.parseInt(smajor_db_gb_m);
                ...
                txData[14] = (byte) Integer.parseInt(smajor_db_a_f);
                txData[15] = (byte) Integer.parseInt(smajor_db_a_h);
                txData[16] = (byte) Integer.parseInt(smajor_db_a_m);
                ...
                txData[18] = (byte) Integer.parseInt(smajor_as_gd_f);
                txData[19] = (byte) Integer.parseInt(smajor_as_gd_h);
                txData[20] = (byte) Integer.parseInt(smajor_as_gd_m);
                ...
                txData[21] = (byte) Integer.parseInt(smajor_as_g_f);
                txData[22] = (byte) Integer.parseInt(smajor_as_g_h);
                txData[23] = (byte) Integer.parseInt(smajor_as_g_m);
                ...
                txData[24] = (byte) Integer.parseInt(smajor_as_gb_f);
                txData[25] = (byte) Integer.parseInt(smajor_as_gb_h);
                txData[26] = (byte) Integer.parseInt(smajor_as_gb_m);
                ...
                txData[27] = (byte) Integer.parseInt(smajor_as_a_f);
                txData[28] = (byte) Integer.parseInt(smajor_as_a_h);
                txData[29] = (byte) Integer.parseInt(smajor_as_a_m);
                ...
                txData[5] = (byte) Integer.parseInt(fmax_cw_gd_f);
                txData[6] = (byte) Integer.parseInt(fmax_cw_gd_h);
                txData[7] = (byte) Integer.parseInt(fmax_cw_gd_m);
                ...
                txData[8] = (byte) Integer.parseInt(fmax_cw_g_f);
                txData[9] = (byte) Integer.parseInt(fmax_cw_g_h);
                txData[10] = (byte) Integer.parseInt(fmax_cw_g_m);
                ...
                txData[11] = (byte) Integer.parseInt(fmax_cw_gb_f);
                txData[12] = (byte) Integer.parseInt(fmax_cw_gb_h);
                txData[13] = (byte) Integer.parseInt(fmax_cw_gb_m);
                ...
                txData[14] = (byte) Integer.parseInt(fmax_cw_a_f);
                txData[15] = (byte) Integer.parseInt(fmax_cw_a_h);
                txData[16] = (byte) Integer.parseInt(fmax_cw_a_m);
                ...
                txData[18] = (byte) Integer.parseInt(fmax_fs_gd_f);
                txData[19] = (byte) Integer.parseInt(fmax_fs_gd_h);
                txData[20] = (byte) Integer.parseInt(fmax_fs_gd_m);
                ...
                txData[21] = (byte) Integer.parseInt(fmax_fs_g_f);
                txData[22] = (byte) Integer.parseInt(fmax_fs_g_h);
                txData[23] = (byte) Integer.parseInt(fmax_fs_g_m);
                ...
                txData[24] = (byte) Integer.parseInt(fmax_fs_gb_f);
                txData[25] = (byte) Integer.parseInt(fmax_fs_gb_h);
                txData[26] = (byte) Integer.parseInt(fmax_fs_gb_m);
                ...
                txData[27] = (byte) Integer.parseInt(fmax_fs_a_f);
                txData[28] = (byte) Integer.parseInt(fmax_fs_a_h);
                txData[29] = (byte) Integer.parseInt(fmax_fs_a_m);
                ...
                txData[31] = (byte) Integer.parseInt(fmax_rw_gd_f);
                txData[32] = (byte) Integer.parseInt(fmax_rw_gd_h);
                txData[33] = (byte) Integer.parseInt(fmax_rw_gd_m);
                ...
                txData[34] = (byte) Integer.parseInt(fmax_rw_g_f);
                txData[35] = (byte) Integer.parseInt(fmax_rw_g_h);
                txData[36] = (byte) Integer.parseInt(fmax_rw_g_m);
                ...
                txData[37] = (byte) Integer.parseInt(fmax_rw_gb_f);
                txData[38] = (byte) Integer.parseInt(fmax_rw_gb_h);
                txData[39] = (byte) Integer.parseInt(fmax_rw_gb_m);
                ...
                txData[40] = (byte) Integer.parseInt(fmax_rw_a_f);
                txData[41] = (byte) Integer.parseInt(fmax_rw_a_h);
                txData[42] = (byte) Integer.parseInt(fmax_rw_a_m);
                ...
                txData[44] = (byte) Integer.parseInt(fmax_bw_gd_f);
                txData[45] = (byte) Integer.parseInt(fmax_bw_gd_h);
                txData[46] = (byte) Integer.parseInt(fmax_bw_gd_m);
                ...
                txData[47] = (byte) Integer.parseInt(fmax_bw_g_f);
                txData[48] = (byte) Integer.parseInt(fmax_bw_g_h);
                txData[49] = (byte) Integer.parseInt(fmax_bw_g_m);
                ...
                txData[50] = (byte) Integer.parseInt(fmax_bw_gb_f);
                txData[51] = (byte) Integer.parseInt(fmax_bw_gb_h);
                txData[52] = (byte) Integer.parseInt(fmax_bw_gb_m);
                ...
                txData[53] = (byte) Integer.parseInt(fmax_bw_a_f);
                txData[54] = (byte) Integer.parseInt(fmax_bw_a_h);
                txData[55] = (byte) Integer.parseInt(fmax_bw_a_m);
                ...
                txData[5] = (byte) Integer.parseInt(smax_db_gd_f);
                txData[6] = (byte) Integer.parseInt(smax_db_gd_h);
                txData[7] = (byte) Integer.parseInt(smax_db_gd_m);
                ...
                txData[8] = (byte) Integer.parseInt(smax_db_g_f);
                txData[9] = (byte) Integer.parseInt(smax_db_g_h);
                txData[10] = (byte) Integer.parseInt(smax_db_g_m);
                ...
                txData[11] = (byte) Integer.parseInt(smax_db_gb_f);
                txData[12] = (byte) Integer.parseInt(smax_db_gb_h);
                txData[13] = (byte) Integer.parseInt(smax_db_gb_m);
                ...
                txData[14] = (byte) Integer.parseInt(smax_db_a_f);
                txData[15] = (byte) Integer.parseInt(smax_db_a_h);
                txData[16] = (byte) Integer.parseInt(smax_db_a_m);
                ...
                txData[18] = (byte) Integer.parseInt(smax_as_gd_f);
                txData[19] = (byte) Integer.parseInt(smax_as_gd_h);
                txData[20] = (byte) Integer.parseInt(smax_as_gd_m);
                ...
                txData[21] = (byte) Integer.parseInt(smax_as_g_f);
                txData[22] = (byte) Integer.parseInt(smax_as_g_h);
                txData[23] = (byte) Integer.parseInt(smax_as_g_m);
                ...
                txData[24] = (byte) Integer.parseInt(smax_as_gb_f);
                txData[25] = (byte) Integer.parseInt(smax_as_gb_h);
                txData[26] = (byte) Integer.parseInt(smax_as_gb_m);
                ...
                txData[27] = (byte) Integer.parseInt(smax_as_a_f);
                txData[28] = (byte) Integer.parseInt(smax_as_a_h);
                txData[29] = (byte) Integer.parseInt(smax_as_a_m);
                ...
                txData[31] = (byte) Integer.parseInt(smax_m_gd_f);
                txData[32] = (byte) Integer.parseInt(smax_m_gd_h);
                txData[33] = (byte) Integer.parseInt(smax_m_gd_m);
                ...
                txData[34] = (byte) Integer.parseInt(smax_m_g_f);
                txData[35] = (byte) Integer.parseInt(smax_m_g_h);
                txData[36] = (byte) Integer.parseInt(smax_m_g_m);
                ...
                txData[37] = (byte) Integer.parseInt(smax_m_gb_f);
                txData[38] = (byte) Integer.parseInt(smax_m_gb_h);
                txData[39] = (byte) Integer.parseInt(smax_m_gb_m);
                String smax_m_a_f = "0";
                ...
                txData[40] = (byte) Integer.parseInt(smax_m_a_f);
                txData[41] = (byte) Integer.parseInt(smax_m_a_h);
                txData[42] = (byte) Integer.parseInt(smax_m_a_m);
                ...
                txData[44] = (byte) Integer.parseInt(smax_sb_gd_f);
                txData[45] = (byte) Integer.parseInt(smax_sb_gd_h);
                txData[46] = (byte) Integer.parseInt(smax_sb_gd_m);
                ...
                txData[47] = (byte) Integer.parseInt(smax_sb_g_f);
                txData[48] = (byte) Integer.parseInt(smax_sb_g_h);
                txData[49] = (byte) Integer.parseInt(smax_sb_g_m);
                ...
                txData[50] = (byte) Integer.parseInt(smax_sb_gb_f);
                txData[51] = (byte) Integer.parseInt(smax_sb_gb_h);
                txData[52] = (byte) Integer.parseInt(smax_sb_gb_m);
                ...
                txData[53] = (byte) Integer.parseInt(smax_sb_a_f);
                txData[54] = (byte) Integer.parseInt(smax_sb_a_h);
                txData[55] = (byte) Integer.parseInt(smax_sb_a_m);
                ...
                txData[5] = (byte) Integer.parseInt(manual_c1_gd_f);
                txData[6] = (byte) Integer.parseInt(manual_c1_gd_h);
                txData[7] = (byte) Integer.parseInt(manual_c1_gd_m);
                ...
                txData[8] = (byte) Integer.parseInt(manual_c1_g_f);
                txData[9] = (byte) Integer.parseInt(manual_c1_g_h);
                txData[10] = (byte) Integer.parseInt(manual_c1_g_m);
                ...
                txData[11] = (byte) Integer.parseInt(manual_c1_gb_f);
                txData[12] = (byte) Integer.parseInt(manual_c1_gb_h);
                txData[13] = (byte) Integer.parseInt(manual_c1_gb_m);
                ...
                txData[14] = (byte) Integer.parseInt(manual_c1_a_f);
                txData[15] = (byte) Integer.parseInt(manual_c1_a_h);
                txData[16] = (byte) Integer.parseInt(manual_c1_a_m);
                ...
                txData[18] = (byte) Integer.parseInt(manual_c2_gd_f);
                txData[19] = (byte) Integer.parseInt(manual_c2_gd_h);
                txData[20] = (byte) Integer.parseInt(manual_c2_gd_m);
                ...
                txData[21] = (byte) Integer.parseInt(manual_c2_g_f);
                txData[22] = (byte) Integer.parseInt(manual_c2_g_h);
                txData[23] = (byte) Integer.parseInt(manual_c2_g_m);
                ...
                txData[24] = (byte) Integer.parseInt(manual_c2_gb_f);
                txData[25] = (byte) Integer.parseInt(manual_c2_gb_h);
                txData[26] = (byte) Integer.parseInt(manual_c2_gb_m);
                ...
                txData[27] = (byte) Integer.parseInt(manual_c2_a_f);
                txData[28] = (byte) Integer.parseInt(manual_c2_a_h);
                txData[29] = (byte) Integer.parseInt(manual_c2_a_m);
                ...
                txData[31] = (byte) Integer.parseInt(manual_c3_gd_f);
                txData[32] = (byte) Integer.parseInt(manual_c3_gd_h);
                txData[33] = (byte) Integer.parseInt(manual_c3_gd_m);
                ...
                txData[34] = (byte) Integer.parseInt(manual_c3_g_f);
                txData[35] = (byte) Integer.parseInt(manual_c3_g_h);
                txData[36] = (byte) Integer.parseInt(manual_c3_g_m);
                ...
                txData[37] = (byte) Integer.parseInt(manual_c3_gb_f);
                txData[38] = (byte) Integer.parseInt(manual_c3_gb_h);
                txData[39] = (byte) Integer.parseInt(manual_c3_gb_m);
                ...
                txData[40] = (byte) Integer.parseInt(manual_c3_a_f);
                txData[41] = (byte) Integer.parseInt(manual_c3_a_h);
                txData[42] = (byte) Integer.parseInt(manual_c3_a_m);
                ...
                txData[44] = (byte) Integer.parseInt(manual_c4_gd_f);
                txData[45] = (byte) Integer.parseInt(manual_c4_gd_h);
                txData[46] = (byte) Integer.parseInt(manual_c4_gd_m);
                ...
                txData[47] = (byte) Integer.parseInt(manual_c4_g_f);
                txData[48] = (byte) Integer.parseInt(manual_c4_g_h);
                txData[49] = (byte) Integer.parseInt(manual_c4_g_m);
                ...
                txData[50] = (byte) Integer.parseInt(manual_c4_gb_f);
                txData[51] = (byte) Integer.parseInt(manual_c4_gb_h);
                txData[52] = (byte) Integer.parseInt(manual_c4_gb_m);
                ...
                txData[53] = (byte) Integer.parseInt(manual_c4_a_f);
                txData[54] = (byte) Integer.parseInt(manual_c4_a_h);
                txData[55] = (byte) Integer.parseInt(manual_c4_a_m);
